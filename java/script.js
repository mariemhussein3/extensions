    ...
    temp += `<div class="col">
            <div class="card">
              ...
              <div class="footer-card">
               <div class="remove">
                <span onclick="handleDelete(${i})">Remove</span>
               </div>
                  <div class="for-switch"><label class="switch">
                    <input type="checkbox" onchange=" handleSwitch(${i},this)"  class="checkInput" ${isActive&&"checked"}/>
...
//   iconLogo.classList.add("only-dark")
